            ...
            <div className="bg-white p-4 rounded-lg shadow-sm border border-gray-200">
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-lg sm:text-xl font-semibold">{stats.totalProducts}</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white p-4 rounded-lg shadow-sm border border-gray-200">
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-lg sm:text-xl font-semibold">{formatMoney(stats.totalValue)}</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white p-4 rounded-lg shadow-sm border border-gray-200">
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-lg sm:text-xl font-semibold">{stats.lowStockCount}</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white p-4 rounded-lg shadow-sm border border-gray-200">
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-lg sm:text-xl font-semibold">{stats.categories}</p>
                </div>
              </div>
            </div>
          </div>
